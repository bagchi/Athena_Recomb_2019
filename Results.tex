...
\hline
{Dataset} & \multicolumn{3}{c|}{With \name (N-gram)}& \multicolumn{3}{c|}{With \name (RNN)} & \multicolumn{3}{c|}{\makecell{Exhaustive Search}} \\ 
 \hline
 					 & \makecell{Selected\\ $k$} & \makecell{Alignment\\ Rate}& Gain (\%) & \makecell{Selected \\ $k$} & \makecell{Alignment\\ Rate}& Gain (\%) & \makecell{Selected \\ $k$} & \makecell{Alignment\\ Rate}& Gain (\%) 
\\ \hline
 					 D1 & \textbf{k=17} & \textbf{98.95}\% & \textbf{96.3}\% & \textbf{k=17} & \textbf{98.95}\% & \textbf{96.3}\%  & \textbf{k=17} & \textbf{98.95}\% & \textbf{96.3}\%
\\ \hline
                          %&  & k = 8 &  204.849 &  121.88 & 56.9\% \\ 
     					  D2 & \textbf{k=17} & 61.15\% & \textbf{80.1}\% & \textbf{k=17} & 61.15\% & \textbf{80.1}\% & k=15 & \textbf{61.42\%} & 73.8\% 
\\ \hline
 					      %&  & k = 8 &  200.513 &  52.82 & 72.91\% \\ 
     				 D3 & \textbf{k=17} &  80.39\% & \textbf{95.34\%} & k=15 & \textbf{80.44\%} & 86.78 \% & k=15 & \textbf{80.44\%} & 86.78 \% 
\\ \hline                        
                         D4 & \textbf{k=17} & \textbf{93.95}\% & \textbf{89.87\%} &
...
\begin{table}[H]
\centering
\caption {Comparison of Overall Alignment Rate between Fiona's and RACER's (with and without \name's tuning). The last two columns demonstrate the strong anti-correlation values between Perplexity and Alignment Rate.}
\scalebox{0.85}{
\begin{tabular}{ |c|c|c|c|c|c| }
\hline
\makecell{Dataset} & \makecell{Fiona} & \makecell{RACER \\ w/o \name \\ + Bowtie2} & \makecell{RACER \\ with \name \\ + Bowtie2}& \makecell{Correlation \\ (N-Gram)} & \makecell{Correlation \\ (RNN)} \\ 
\hline
D1 &  99.25\% & 85.01\% & \textbf{99.26}\% &  -0.977 & -0.938 \\
D2 &  73.75\% & 58.66\% & \textbf{81.15}\%&  -0.981 & -0.969 \\
D3 &  83.12\% & 80.79\% & \textbf{84.11}\% &  -0.982 & -0.968 \\
D4 &  95.33\% & 93.86\% &	95.33\% &  -0.946 & -0.930 \\
D5 &  \textbf{92.34}\% & 90.91\% &	92.29\% &  -0.970 & -0.962\\
\hline
\end{tabular}}

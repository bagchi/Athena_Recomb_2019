...
% Mus: Done.
Therefore, a data-driven  method for finding the best value of \textit{k} and other configuration parameters is needed for improved error correction, and subsequently, for superior genome assemblies or other applications downstream. \SCcomment{we don't evaluate genome assembly, so a little dicey to say this}.
